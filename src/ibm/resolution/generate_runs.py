...
# generate permutations of parameters to run the 
# simulations

import numpy as np

exe_name = "./xpo_resolution"
...
step = 0.05
c1list = list(np.arange(0,1+step,step))
            ...
            for c2_i in c2list:
                for li in llist:
                    for gamma_beta_i in gamma_beta_combis:
                        ...
                        print("echo " + str(ctr))
                        ctr+=1
                        print(exe_name + " " + str(mu_s) + " "  + str(mu_q) + " " + str(sdmu) + " " + str(c1_i) + " " + str(c2_i) + " " + \
                                str(p) + " " + str(d) + " " + str(li) + " " + str(sigma12_i) + " " + str(sigma21_i) + " " + \
                                str(gamma1_i) + " " + str(gamma2_i) + " " + str(beta1_i) + " " + str(beta2_i) + " " + \
                                str(initqS) + " " + str(initqNS) + " " + str(inits1) + " " + str(inits2))
